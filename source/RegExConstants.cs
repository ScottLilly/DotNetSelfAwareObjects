namespace SAO
{
    public static class RegExConstants
    {
        ...
        {
            public const string EMAIL_ADDRESS = @"^([0-9a-zA-Z]([-\.\w]*[0-9a-zA-Z])*@([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,9})$";
            public const string FILE_NAME = @"^(?!^(PRN|AUX|CLOCK\$|NUL|CON|COM\d|LPT\d|\..*)(\..+)?$)[^\x00-\x1f\\?*:\;|/]+$";
        ...
        {
            public const string ANY_CARD_NUMBER = @"^((?:4\d{3})|(?:5[1-5]\d{2})|(?:6011)|(?:3[68]\d{2})|(?:30[012345]\d))[ -]?(\d{4})[ -]?(\d{4})[ -]?(\d{4}|3[4,7]\d{13})$";
        ...
        public static class CountrySpecific
        {
            ...
            public static class Australia
            {
                ...
                {
                    public const string GENERAL = @"(^1300\d{6}$)|(^1800|1900|1902\d{6}$)|(^0[2|3|7|8]{1}[0-9]{8}$)|(^13\d{4}$)|(^04\d{2,3}\d{6}$)";
            ...
            public static class Brazil
            {
                ...
                public static class PhoneNumber
                {
                    public const string GENERAL = @"^([0-9]{2})?((\([0-9]{2})\)|[0-9]{2})?([0-9]{3}|[0-9]{4})(\-)?[0-9]{4}$";
                }
            }
            ...
            public static class Canada
            {
                ...
                public const string POSTAL_CODE_QUEBEC = @"^[a-zA-Z]{1}[0-9]{1}[a-zA-Z]{1}(\-| |){1}[0-9]{1}[a-zA-Z]{1}[0-9]{1}$";
            ...
            {
                public const string POSTAL_CODE = @"\b((?:0[1-46-9]\d{3})|(?:[1-357-9]\d{4})|(?:[4][0-24-9]\d{3})|(?:[6][013-9]\d{3}))\b";
            }

            public static class India
            {
                public const string POSTAL_CODE = @"^\d{3}\s?\d{3}$";
                public const string VEHICLE_REGISTRATION_NUMBER = @"^([A-Z|a-z]{2}\s{1}\d{2}\s{1}[A-Z|a-z]{1,2}\s{1}\d{1,4})?([A-Z|a-z]{3}\s{1}\d{1,4})?$";
            ...
            public static class Italy
            {
                ...
                public static class PhoneNumber
                {
                    ...
                    public const string MOBILE = @"^([+]39)?((38[{8,9}|0])|(34[{7-9}|0])|(36[6|8|0])|(33[{3-9}|0])|(32[{8,9}]))([\d]{7})$";
                }
            }
            ...
            {
                public const string RFC_NUMBER = @"^([A-Z|a-z|&amp;]{3}\d{2}((0[1-9]|1[012])(0[1-9]|1\d|2[0-8])|(0[13456789]|1[012])(29|30)|(0[13578]|1[02])31)|([02468][048]|[13579][26])0229)(\w{2})([A|a|0-9]{1})$|^([A-Z|a-z]{4}\d{2}((0[1-9]|1[012])(0[1-9]|1\d|2[0-8])|(0[13456789]|1[012])(29|30)|(0[13578]|1[02])31)|([02468][048]|[13579][26])0229)((\w{2})([A|a|0-9]{1})){0,3}$";
            }
            ...
            {
                public const string PERSONAL_IDENTIFICATION_NUMBER = @"[1-2][0|9][0-9]{2}[0-1][0-9][0-3][0-9][-][0-9]{4}";
                public const string POSTAL_CODE = @"^[S-s]( |-)?[1-9]{1}[0-9]{2}( |-)?[0-9]{2}$";

                public static class PhoneNumber
                {
                    public const string GENERAL = @"^(([+]\d{2}[ ][1-9]\d{0,2}[ ])|([0]\d{1,3}[-]))((\d{2}([ ]\d{2}){2})|(\d{3}([ ]\d{3})*([ ]\d{2})+))$";
                }
            }
            ...
            public static class UAE
            {
                public static class PhoneNumber
                {
                    ...
                    public const string MOBILE = @"^(\+97[\s]{0,1}[\-]{0,1}[\s]{0,1}1|0)50[\s]{0,1}[\-]{0,1}[\s]{0,1}[1-9]{1}[0-9]{6}$";
                }
            }
            ...
            public static class UK
            {
                ...
                public const string NATIONAL_INSURANCE_NUMBER = @"^[A-CEGHJ-PR-TW-Z]{1}[A-CEGHJ-NPR-TW-Z]{1}[0-9]{6}[A-DFM]{0,1}$";
                public const string POSTAL_CODE = @"^[A-Z]{1,2}[1-9][0-9]?[A-Z]? [0-9][A-Z]{2,}|GIR 0AA$";
                public const string VEHICLE_REGISTRATION_NUMBER = @"^([A-Z]{3}\s?(\d{3}|\d{2}|d{1})\s?[A-Z])|([A-Z]\s?(\d{3}|\d{2}|\d{1})\s?[A-Z]{3})|(([A-HK-PRSVWY][A-HJ-PR-Y])\s?([0][2-9]|[1-9][0-9])\s?[A-HJ-PR-Z]{3})$";

                public static class PhoneNumber
                {
                    public const string LAND_LINE = @"(02\d\s?\d{4}\s?\d{4})|(01\d{2}\s?\d{3}\s?\d{4})|(01\d{3}\s?\d{5,6})|(01\d{4}\s?\d{4,5})";
            ...
            public static class US
            {
                ...
                public const string SOCIAL_SECURITY_NUMBER = @"^(?=((0[1-9]0)|([1-7][1-7]\d)|(00[1-9])|(0[1-9][1-9]))-(?=(([1-9]0)|(0[1-9])|([1-9][1-9]))-(?=((\d{3}[1-9])$|([1-9]\d{3})$|(\d[1-9]\d{2})$|(\d{2}[1-9]\d)$))))";
